    ...
    return (
        ...
        <form action={formAction} className='flex flex-col gap-7'>
            ...
            <div className=' flex flex-col gap-2'>
                ...
                <input name="firstname" className=' h-13 border-2 w-75 rounded-2xl' type="text" />
                <label htmlFor="">Lastname</label>
                <input name="lastname" className=' h-13  border-2 w-75 rounded-2xl' type="text" />
                <label htmlFor="">Username</label>
                <input name="username" className=' h-13  border-2 w-75 rounded-2xl' type="text" />
                <label htmlFor="">Email</label>
                <input name="email" className=' h-13  border-2 w-75 rounded-2xl' type="text" />
                <label htmlFor="">Password</label>
                <input name="password" className=' h-13  border-2 w-75 rounded-2xl' type="text" />
            </div>

            <button className=' bg-amber-50 text-black  h-13  border-2 w-75  rounded-2xl'>{pending ? 'Loading...' : 'Sign up'}</button>
